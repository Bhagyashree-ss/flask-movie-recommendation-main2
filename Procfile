...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/login1'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False


# contact
app.secret_key = 'your-secret-key'  # Replace with your own secret key
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///login1.db'
...
def contact():
    ...
    return render_template('contact.html', form=form)  # Create an HTML template for your contact form
